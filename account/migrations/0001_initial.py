...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='brand_followers', to='account.branduser')),
            ],
        ),
        migrations.CreateModel(
            name='BrandProfile',
            fields=[
                ...
                ('date_created', models.DateTimeField(default=datetime.datetime(2023, 10, 30, 20, 50, 19, 38834, tzinfo=utc))),
                ...
                ('state', models.CharField(default='', max_length=250)),
                ('zip', models.CharField(default='', max_length=250)),
                ('followers', models.ManyToManyField(to='account.Followers')),
                ('user', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='brand_profile', to='account.branduser')),
            ],
        ),
    ]
