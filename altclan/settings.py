...
DATABASES = {
       'default': dj_database_url.config(default='postgres://postgresql://altclan_yq5p_user:ZLfoYMgEcGtMEuR52HjUOVHSZXEQ6VrS@dpg-cu0h18d6l47c73fq650g-a.oregon-postgres.render.com/altclan_yq5p')
}
