...
DATABASES = {
       'default': dj_database_url.config(default='postgres://postgresql://altclan_e68n_user:iIRHTqEvDQlAZcWDyRPLvEOu8mfhp3As@dpg-cu0gajl6l47c73fptrjg-a.oregon-postgres.render.com/altclan_e68n')
}
