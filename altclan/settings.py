...
DATABASES = {
       'default': dj_database_url.config(default='postgres://postgresql://altclan_3mw4_user:IbKyZhq1i8wrgrXzhMVLAoYlHOiftRvi@dpg-ctt9s6q3esus7392iu2g-a.oregon-postgres.render.com/altclan_3mw4')
}
