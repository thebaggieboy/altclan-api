...
DATABASES = {
       'default': dj_database_url.config(default='postgres://postgresql://altclan_eh2g_user:MM6uIMm8tqqrRBop8y5PufZUucIE4voP@dpg-cvt7ifqdbo4c73cjitjg-a.oregon-postgres.render.com/altclan_eh2g')
}
