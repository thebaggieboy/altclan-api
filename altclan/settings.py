...
ALLOWED_HOSTS = [ 'localhost', '127.0.0.1', 'altclan-api.onrender.com']
...
DATABASES = {
       'default': dj_database_url.config(default='postgres://postgresql://altclan_md6w_user:g5IYA7Iax4fIx5JQ0IpT9wzaoAmaXcPB@dpg-d0idtlmuk2gs73apg1jg-a.oregon-postgres.render.com/altclan_md6w')
}
