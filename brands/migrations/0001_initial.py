    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(default=datetime.datetime(2025, 1, 10, 20, 49, 43, 649405, tzinfo=datetime.timezone.utc))),
            ],
        ),
        migrations.CreateModel(
            name='WishList',
            fields=[
                ...
                ('product_name', models.CharField(blank=True, default='', max_length=250, null=True)),
                ('display_image', models.ImageField(blank=True, null=True, upload_to='WishList Images')),
                ('colors', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=250), blank=True, null=True, size=None)),
            ],
        ),
        migrations.CreateModel(
